<template>
  <default>
    <div :data-theme="value" class="grid grid-cols-2 items-center">
      <div>
        <slot />
      </div>
      <div class="grid gap-2">
        <kol-card class="pl-8" _heading="Button-Komponente" _has-footer>
          <div
            slot="content"
            class="p-2 grid grid-cols-[1.5fr_1fr] items-center"
          >
            <div class="grid gap-2">
              ...
              <div class="text-center">
                <kol-button
                  _label="Secondary"
                  :_icon="{ right: 'codicon codicon-edit' }"
                  _variant="secondary"
                ></kol-button>
              </div>
              <div class="text-center">
              ...
              <div class="text-center">
                <kol-button
                  _label="Ghost"
                  :_icon="{ right: 'codicon codicon-lightbulb' }"
                  _variant="ghost"
                ></kol-button>
              </div>
            </div>
          ...
          <div
            slot="footer"
            class="p-2 grid grid-cols-[1fr_auto] gap-4 items-end"
          >
            <kol-select
              :_hide-label="true"
              :_list="options"
